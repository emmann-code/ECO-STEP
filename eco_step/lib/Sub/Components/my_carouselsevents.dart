                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Center(child: Text(event['title']!,style: GoogleFonts.adamina(fontWeight: FontWeight.w400,fontSize: 25,color: Colors.white),)),
                      ),
                      Text(event['date']!,style: GoogleFonts.aboreto(fontWeight: FontWeight.w400,fontSize: 20,color: Colors.white),),
                      Text('by ${event['organizer']}',style: GoogleFonts.mansalva(fontWeight: FontWeight.w400,fontSize: 20,color: Colors.white),),
                    ],
                  ),
                ),
              ),
